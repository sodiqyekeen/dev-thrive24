from db import *
from models.skill_exchange_model import *
...
def add_new_Skill_Exchange(student1_ID, student2_ID, skill_ID, Satatus):
    db = get_db()
    cur = db.cursor()
    cur.execute("INSERT INTO Skill_Exchange (student1_ID, student2_ID, skill_ID, Satatus) VALUES (?,?,?,?)", (student1_ID, student2_ID, skill_ID, Satatus))
    db.commit()
    return cur.lastrowid

def Skill_Exchange_exists(student1_ID, student2_ID, skill_ID, Satatus):
    db = get_db()
    cur = db.cursor()
